    ...
    public class ApplicationDateValidator : AbstractValidator<ApplicationDate>
    {
        public ApplicationDateValidator()
        {
            ...
            RuleFor(applicationDate => applicationDate.SubmitDate)
                .NotEmpty().WithMessage("SubmitDate is required.")
                .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("SubmitDate cannot be in the future.");
            ...
            RuleFor(applicationDate => applicationDate.ReviewDate)
                ...
                .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("ReviewDate cannot be in the future.");
            ...
            RuleFor(applicationDate => applicationDate.DecisionDate)
                ...
                .LessThanOrEqualTo(DateTime.UtcNow).WithMessage("DecisionDate cannot be in the future.");
