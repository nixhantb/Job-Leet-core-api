...
namespace JobLeet.WebApi.JobLeet.Api.Controllers.Common.V1
{
    ...
    {
        public QualificationController(IQualificationTypeRepository qualificationTypeRepository, ILoggerManagerV1 logger, RabbitMQService rabbitMQService)
            : base(qualificationTypeRepository, logger, rabbitMQService)
        {
