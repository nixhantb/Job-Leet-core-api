    ...
    public class EducationValidator : AbstractValidator<Education>
    {
        public EducationValidator()
        {
            ...
            RuleFor(x => x.GraduationDate)
                ...
                .LessThanOrEqualTo(DateOnly.FromDateTime(DateTime.Now)).WithMessage("Graduation Date cannot be in the future");

            RuleFor(x => x.Cgpa)
                .InclusiveBetween(0, 4.0m).WithMessage("CGPA must be between 0.0 and 4.0");
        }
    }
}
